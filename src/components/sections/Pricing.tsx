...
const PLANS: Plan[] = [
  {
    ...
    features: [
      { label: '3 serveurs max', included: true },
      { label: '3 tickets simultanés', included: true },
      { label: 'Logs 14 jours', included: true },
      { label: 'Support standard', included: true },
      { label: 'Anti-Raid, Nuke, Spam', included: true },
      { label: 'Anti-Phishing, Risk Scoring', included: true },
      { label: 'Verification', included: false },
      { label: 'Behaviour Graph, File Scanner', included: false },
      { label: 'API Access, White-label', included: false },
    ],
  ...
  },
  {
    ...
    popular: true,
    features: [
      { label: '10 serveurs max', included: true },
      { label: '10 tickets simultanés', included: true },
      { label: 'Logs 60 jours', included: true },
      { label: 'Support prioritaire', included: true },
      { label: 'Tout le plan Free', included: true },
      { label: 'Verification', included: true },
      { label: 'Behaviour Graph', included: false },
      { label: 'File Scanner, API Access', included: false },
  ...
  },
  {
    ...
    features: [
      { label: '25 serveurs max', included: true },
      { label: '25 tickets simultanés', included: true },
      { label: 'Logs 180 jours', included: true },
      { label: 'Support prioritaire', included: true },
      { label: 'Tout le plan Pro', included: true },
      { label: 'Behaviour Graph', included: true },
      { label: 'File Scanner', included: true },
  ...
  },
  {
    ...
    features: [
      { label: '50 serveurs max', included: true },
      { label: '50 tickets simultanés', included: true },
      { label: 'Logs 365 jours', included: true },
      { label: 'Support dédié', included: true },
      { label: 'Tout le plan Business', included: true },
